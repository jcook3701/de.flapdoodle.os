...
class PopOsVersionTest {
  ...
  @Test
  public void popOsVersionIdMustMatchPopOsVersion() {
    assertVersion("22.04", PopOsVersion.PopOs_22_04);
  }

  private static void assertVersion(String versionIdContent, PopOsVersion version) {
